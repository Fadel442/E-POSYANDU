    ...
    <div class="w-[80%] h-full container mx-5 ">
        <div>
            ...
            <dialog id="my_modal_1" class="modal">
                <div class="modal-box">
                    <h3 class="font-bold text-lg mb-2">Input Data Pemeriksaan</h3>
                    <h3 class="font-bold text-lg">Ibu Hamil</h3>
                    <hr>
                    ...
                    <form action="">
                        ...
                        <label class="form-control w-full">
                            ...
                            <select class="select select-bordered w-full">
                                <option disabled selected>Pilih Ibu Hamil</option>
                                <option value=""></option>
                            </select>
                        </label>
                        <label class="form-control w-full">
                        ...
                        <label class="form-control w-full">
                            <div class="label">
                                <span class="label-text">Umur Kelahiran</span>
                            </div>
                        ...
                        <div class="flex">
                            <div class="flex-1 w-[50%] flex flex-col">
                                ...
                                <label class="form-control w-full">
                                    <div class="label">
                                        <span class="label-text">Lingkar Lengan Atas</span>
                                    </div>
                                    <input type="text" placeholder="Type here" class="input input-bordered w-full" />
                                </label>
                            </div>
                            ...
                            <div class="flex-1 w-[50%] flex flex-col">
                                ...
                                <label class="form-control w-full">
                                    <div class="label">
                                        <span class="label-text">Lingkar Perut</span>
                                    </div>
                                    <input type="text" placeholder="Type here" class="input input-bordered w-full" />
                                </label>
                                <label class="form-control w-full">
                                    <div class="label">
                                        <span class="label-text">Tinggi Fundus Uteri</span>
                                    </div>
                                    <input type="text" placeholder="Type here" class="input input-bordered w-full" />
                                </label>
                                <label class="form-control w-full">
                                    <div class="label">
                                        <span class="label-text">Denyut Jantung Janin</span>
                                    </div>
                                    <input type="text" placeholder="Type here" class="input input-bordered w-full" />
                                </label>
                            </div>
