        ...
        <div class="bg-[#1A4D2E] rounded-lg">
            <div class="px-10 pt-5"> 
                ...
                <div class="mb-2">
                    ...
                    <input type="text" placeholder="" class="bg-white border border-black text-sm rounded-lg  block w-full p-2.5 mt-1" />
                </div>
                <div class="mb-2">
                ...
                <div class="mb-2">
                    ...
                    <input type="password" placeholder="" class="bg-white border border-black text-sm rounded-lg  block w-full p-2.5 mt-1" />
                </div>
                <div class="container py-5 px-10 min-w-full flex flex-col items-end">
                    <button type="button" class="text-white bg-[#4F6F52] font-medium rounded-lg  px-5 py-2.5 text-center me-2 mb-2">Confrirm</button>
                </div>
            </div>
        </div>
    </div>
