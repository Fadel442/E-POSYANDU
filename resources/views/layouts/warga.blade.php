                ...
                <div class="grid grid-flow-row auto-rows-max">
                    ...
                    <div class="flex">
                        <ul class="menu menu-horizontal px-1 mt-1">
                            <li><a class="text-2xl font-semibold text-[#1A4D2E] no-underline hover:underline">Home</a></li>
                            <li><a class="text-2xl font-semibold text-[#1A4D2E] no-underline hover:underline">Pengumuman</a></li>
                            <li><a class="text-2xl font-semibold text-[#1A4D2E] no-underline hover:underline">Jadwal</a></li>
                            <li><a class="text-2xl font-semibold text-[#1A4D2E] no-underline hover:underline">Vaksin</a></li>
                        </ul>
                    </div>
                </div>
            </div>
